...
angular.module('Modeler').controller('ConditionExpressionCtrl', [ '$scope', '$modal', function($scope, $modal) {
...
angular.module('Modeler').controller('ConditionExpressionPopupCtrl',
