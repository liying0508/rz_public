...
//		//下载的问题
//		try {
//			System.out.println("要下载了");
//			System.out.println("filename" + fileName);
//			System.out.println("url" + url);
//			System.out.println(URLEncoder.encode(fileName, "utf-8").toString());
//			OSSObject o = (OSSObject) OSSFactory.build().downLoad(response,url, fileName);
//			System.out.println(o.toString());
//			// 读去Object内容  返回
//			BufferedInputStream in = new BufferedInputStream(o.getObjectContent());
//			System.out.println(o.getObjectContent().toString());
//
...
//	}
	...
	public void downLoad(@RequestParam("fileName") String fileName,
		...
		System.out.println("进来了，准备进行下载");
		OSSFactory.build().downLoad(request,response,url, fileName);
