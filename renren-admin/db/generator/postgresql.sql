...
INSERT INTO sys_params(id, param_code, param_value, param_type, remark, creator, create_date, updater, update_date) VALUES (1067246875800000072, 'DEV_TOOLS_PARAM_KEY', '{"packageName":"io.renren","version":"3.0","author":"Mark","email":"sunlightcs@gmail.com","backendPath":"D:\\renrenio\\rz-project\\renren-admin","frontendPath":"D:\\renrenio\\rz-project-admin"}', 0, '代码生成器配置信息', 1067246875800000001, now(), 1067246875800000001, now());
...
INSERT INTO sys_menu (id, pid, url, permissions, type, open_style, icon, sort, creator, create_date, updater, update_date) VALUES (1340949288542347268, 1302850622416084993, 'http://datav.renren.io', '', 0, 1, 'icon-select', 0, 1067246875800000001, now(), 1067246875800000001, now());
